...
const policy = [
  ...
  "Our application uses and displays advertising materials. Upon the first launch, we may request permission to use your device identifiers or other tracking mechanisms allowed by iOS and Android for the purpose of showing personalized advertising, as required by the platform policies. This permission is used solely to provide more relevant ad content, and you may change or withdraw your consent at any time through your device settings.",
  "Some features of our application may transmit user-provided information (such as text inputs or selected content) to OpenAI or other third-party AI service providers. This data is sent exclusively for the purpose of processing your request and generating a response. We do not transmit any additional personal information that could identify you. By using these features, you agree to the transfer of the content you provide for processing by third-party AI services.",
  "We also use PostHog to collect anonymous analytics data, including information about visited screens and in-app user interactions. This data helps us analyze application performance, improve functionality, and identify issues. The analytics collected does not include any information that directly identifies you.",
